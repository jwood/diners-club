...
Rails::Initializer.run do |config|
  ...
  config.action_mailer.smtp_settings = {
    ...
    :authentication => AppConfig.instance.smtp_settings[:authentication],
    :user_name => AppConfig.instance.smtp_settings[:user_name],
    :password => AppConfig.instance.smtp_settings[:password]
  }
end
